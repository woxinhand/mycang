...
<div class="headerAd">
	...
	<%@include file="fenlei.jsp" %>
		...
		<div class="span24">
			...
			<s:if test="#session.cart.cartItems == 0">
			<div class="step step1">
				快去买点东西，操
			</div>
			</s:if>
			<s:else>
				...
				<table>
					...
					<s:iterator value="#session.cart.cartItems">
						<tr>
							...
							<td>
							<s:property value="product.mark_price"/>
							</td>
							<td class="quantity" width="60">
								<s:property value="cout"/>
								<div>
				...
				<div class="total">
					...
					商品金额: <strong id="effectivePrice"><s:property value="subtotal/2"/></strong>
				</div>
				<div class="bottom">
