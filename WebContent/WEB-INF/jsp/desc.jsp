...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
	...
	<meta name="copyright" content="Mango">
		<meta name="keywords" content="家大">
		<meta name="description" content="家大">
<link href="${pageContext.request.contextPath}/csscommon.css" rel="stylesheet" type="text/css">
<link href="${pageContext.request.contextPath}/cssproduct.css" rel="stylesheet" type="text/css">
	...
	<div class="container productList">
		...
		<div class="info">
				<dl>
					<dt>亿家价:</dt>
					<dd>
						<strong><s:property value="model.mark_price" />/份</strong>
							参 考 价：
							<del>￥6.00元/份</del>
					</dd>
				</dl>
