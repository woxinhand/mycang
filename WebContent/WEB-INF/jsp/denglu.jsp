		...
		<div class="span12 last">
			<div class="wrap">
				<div class="main">
					...
					<form id="loginForm" action="${pageContext.request.contextPath}/user_login.action" method="post" novalidate="novalidate"><span><s:fielderror fieldName="username"/></span>
						<table>
							<tbody><tr>
								<th>
										用户名/E-mail:
