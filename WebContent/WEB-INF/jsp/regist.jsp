...
function checkusername(){
	...
	xhr.open("GET","${pageContext.request.contextPath}/user_checkusername.action?"+new Date().getDate()+"&username="+username,true);
	xhr.send(null);
}
 function check(){
	...
	<div class="span5">
		<div class="logo">
			<a href="http://localhost:8080/mango/">
				<img src="${pageContext.request.contextPath}/image/r___________renleipic_01/logo.gif" alt="nibaba">
			</a>
		</div>
	</div>
	<div class="span9">
		...
		<div class="span24">
			<div class="wrap">
				<div class="main clearfix">
					...
					<form id="registerForm" action="${pageContext.request.contextPath}/user_regist" method="post" novalidate="novalidate" onsubmit="return check()">
						...
						<table>
							<tbody><tr>
								...
								<td>
									<input type="text" id="username" name="username"  class="text" maxlength="20" onblur="checkusername"/><span id="span1"><s:fielderror fieldName="username"></s:fielderror></span>
								</td>
							</tr>
							<tr>
								<th>
							...
							<tr>
								...
								<td>
									<input type="password" id="password" name="rePassword" class="text" maxlength="20" autocomplete="off">
								</td>
							</tr>
							<tr>
								<th>
							...
							<tr>
								...
								<td>
									<input type="text" id="phone" name="email" class="text" maxlength="200">
								</td>
							</tr>
									<tr>
										<th>
								...
								<tr>
									...
									<td>
										<span class="fieldSet">
											<input type="text" id="checkcode" name="checkcode" class="text captcha" maxlength="4" autocomplete="off"><img id="checkImg" class="captchaImage" src="${pageContext.request.contextPath}/checkImg.action" title="点击更换验证码" onclick="change()">
										</span>
									</td>
								</tr>
							<tr>
